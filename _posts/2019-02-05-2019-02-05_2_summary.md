...
#### [26. Can clinical decision making be enhanced by artificial intelligence?](https://doi.org/10.1111/bjd.17110){: .btn}
...
#### [27. Breast cancer detection using deep convolutional neural networks and support vector machines.](https://doi.org/10.7717/peerj.6201){: .btn}
...
#### [28. A Novel Protein Subcellular Localization Method With CNN-XGBoost Model for Alzheimer's Disease.](https://dx.doi.org/10.3389/fgene.2018.00751){: .btn}
...
#### [30. Automatic Breast and Fibroglandular Tissue Segmentation in Breast MRI Using Deep Learning by a Fully-Convolutional Residual Neural Network U-Net.](https://linkinghub.elsevier.com/retrieve/pii/S1076-6332(19)30036-4){: .btn}
